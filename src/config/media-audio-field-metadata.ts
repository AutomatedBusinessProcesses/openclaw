...
export const MEDIA_AUDIO_FIELD_HELP: Record<MediaAudioFieldKey, string> = {
  ...
  "tools.media.audio.localOnly":
    "Restrict audio transcription to approved local CLI engines only. When enabled, provider/API audio models and network-backed CLIs are skipped instead of receiving audio bytes.",
  "tools.media.audio.maxBytes":
...
export const MEDIA_AUDIO_FIELD_LABELS: Record<MediaAudioFieldKey, string> = {
  ...
  "tools.media.audio.localOnly": "Local-Only Audio Transcription",
