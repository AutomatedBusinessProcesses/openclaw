...
import { parseModelCallbackData } from "./model-buttons.js";
    ...
    try {
      ...
      if (modelCallback) {
        await editCallbackMessage(
          "Telegram model switching is controlled by the OpenClaw menubar. Use the menu bar Model Bank to switch DeepSeek Pro/Flash or activate a reserve model.",
        );
        return;
      }
